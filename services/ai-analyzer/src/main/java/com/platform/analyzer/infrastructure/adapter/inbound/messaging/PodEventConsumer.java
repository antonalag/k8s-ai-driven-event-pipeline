...
import com.platform.analyzer.domain.port.outbound.LmMessagingPort;
...
public class PodEventConsumer {
    ...
    private static final long ANALYSIS_COOLDOWN_MS = 300_000; // 5 minutes — prevents re-analysis spam after dismiss
