...
class PodAnalyzerServiceTest {
    ...
    void shouldPropagateException() {
        AiLanguageModelPort failingPort = (event, history, context) -> {
            throw new com.platform.analyzer.domain.exception.AiAnalysisException("AI failed");
        };
        ...
        assertThatThrownBy(() -> service.analyse(FAILED_POD_EVENT))
                .isInstanceOf(com.platform.analyzer.domain.exception.AiAnalysisException.class)
